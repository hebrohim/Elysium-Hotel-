...
<section className='flex flex-col py-5 items-center'>
    <div className='mb-3'>
        <img src={welcome} style={{rotate:"360deg"}}/>
    </div>
    <p className='mb-3'>Discover the Perfect Hotel Experience</p>
    <button className='p-4 border border-[#F2911B] rounded-lg flex items-center justify-center'>
